...
![Category](https://img.shields.io/badge/Área-Data%20Science%20%7C%20Engenharia%20de%20Dados-orange)
...
```mermaid
timeline
    title Evolução dos Estudos em Python

    2025-11-23 : Início oficial • Instalação do Python • Ambiente configurado
    2025-11-24 : Operações matemáticas • Comentários • Primeiros comandos
    2025-11-25 : Dia sem estudo
    2025-11-26 : Variáveis • Operadores • Operadores relacionais • Exercícios
    2025-11-27 : Condicionais (if/else/elif) • Teste prático
    2025-11-28 : Laços (while/for/range) • Objetos • Strings
    2025-11-29 : Funções • Arquivos • Listas • Dicionários • Aleatoriedade
    2025-11-30 : Exceções • Python 2 vs 3 • List comprehension • Map/Reduce/Zip
    2025-12-01 : Testes do curso • Certificado concluído
    2025-12-02 : Organização do Learning Log • Estruturação do README técnico
    2025-12-03 : Estruturação do repositório • Pastas • Padrões • Nomeação
```
